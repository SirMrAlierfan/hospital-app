...
const Header = () => {
    ...
    return (
        <header className="px-16 py-5 dark:bg-[#313131] border-b flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
                <Button onClick={toggleTheme}>
                    {theme === "light" ? <svg xmlns="http://www.w3.org/2000/svg" version="1.0" id="Layer_1" width="30px" height="30px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" >
                        <g>
                            <path fill-rule="evenodd" clip-rule="evenodd" fill="#231F20" d="M31.998,14.002c-9.941,0-18,8.059-18,18s8.059,18,18,18   s18-8.059,18-18S41.939,14.002,31.998,14.002z M42.998,33.002c-0.553,0-1-0.447-1-1c0-5.523-4.478-10-10-10c-0.553,0-1-0.447-1-1   s0.447-1,1-1c6.627,0,12,5.373,12,12C43.998,32.555,43.551,33.002,42.998,33.002z" />
                    ...
                    </svg> : <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24" fill="none">
